...
function getStatusBadge(status) {
  // Reuse the single source of truth from badge.js when available.
  if (typeof window !== 'undefined' && typeof window.renderBadge === 'function') {
    return window.renderBadge(status);
  }
  const config = {
